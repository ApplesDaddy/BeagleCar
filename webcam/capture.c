// source: https://github.com/derekmolloy/boneCV/blob/master/README.md
...
static const struct option long_options[] = {
    ...
    {"userp", no_argument, NULL, 'u'},        {"output", no_argument, NULL, 'o'},
    {"format", no_argument, NULL, 'f'},       {"formatH264", no_argument, NULL, 'F'},
    {"count", required_argument, NULL, 'c'},  {0, 0, 0, 0}};
